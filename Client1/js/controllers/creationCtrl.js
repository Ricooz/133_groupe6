  ...
  constructor(vueService) {
    ...
    this.nouvelleQuestionHTML = `<div class="w-full border-2 border-zinc-700 bg-zinc-800 rounded-xl flex flex-col w-full p-2 my-2 question">
      <div class="flex flex-row justify-between items-center mb-4">
          ...
          <button type="button" class="bg-red-800 hover:bg-red-700 text-white text-md font-bold rounded-xl my-2 ml-2 px-4 h-10 buttonDeleteReponse"><i class="fa-solid fa-trash" style="color: #ffffff;"></i></button>
      </div>
    </div>`; // <button type="button" class="bg-blue-700 text-white text-md font-bold rounded-xl ml-2 px-3 h-9 buttonCorrecte"><i class="fa-solid fa-check" style="color: #ffffff;"></i></button>
    this.nouvelleReponseHTML = `<div class="flex flex-row items-center reponse">
      ...
      <button type="button" class="bg-blue-700 border-2 border-blue-700 text-white text-md font-bold rounded-xl ml-2 pr-3 pl-3 h-9 buttonCorrecte"><i class="fa-solid fa-check" style="color: #ffffff;"></i></button>
